...
echo "export AWS_ACCESS_KEY_ID=AKIAZWZOZCKXBPKXLW4K" >> /etc/profile
echo "export AWS_SECRET_ACCESS_KEY=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" >> /etc/profile
echo "export AWS_DEFAULT_REGION=ap-south-1" >> /etc/profile
echo "export CDK_DEFAULT_ACCOUNT=667428655790" >> /etc/profile
